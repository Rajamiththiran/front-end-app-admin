...
/**
 * Reusable statistic card component for dashboard
 ...
 * @param {string|number} props.secondaryValue - Value for secondary statistic
 ...
 * @param {boolean} props.onClick - Click handler for the card
  ...
  return (
    ...
    >
      <Box className="flex items-center mb-3">
        {icon && (
          <Box className={`rounded-full p-2 mr-3 ${iconBgColor}`}>{icon}</Box>
        )}
