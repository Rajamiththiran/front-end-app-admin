...
/**
 * Student list component with search, filter, and pagination
    ...
    <Paper className="p-4">
      <Box className="mb-4">
        ...
        <Typography variant="body2" color="textSecondary">
          Manage student records, registrations, and accounts
        </Typography>
      </Box>
      ...
      <Table
        ...
        loading={loading}
        error={
          loading ? null : students.length === 0 ? "No students found." : null
        }
